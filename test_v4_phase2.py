"""
Test v4 - D: Two-phase model. Tests BOTH forward() and step() generation.
"""
import sys, os, math
...
CKPT = "E:/claude/myllm/model_v4_phase2.pt"
if not os.path.exists(CKPT):
    print("No Phase 2 model found!")
    sys.exit(1)
...
model.eval()
print(f"Loaded Phase 2 model | Device: {device} | Params: {sum(p.numel() for p in model.parameters()):,}")
