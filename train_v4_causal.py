"""
Train v4 - B: Causal Transformer (decoder-only, triangular mask)
Standard baseline: causal attention, no step() path, no gated state.
"""
...
CKPT = "E:/claude/myllm/checkpoint_v4_causal.pt"
...
model_path = "E:/claude/myllm/model_v4_causal.pt"
